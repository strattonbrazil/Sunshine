...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Sun Jul 24 12:33:40 2011
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/X11R6/lib -ldl -lutil -lm -lpython2.7 -lGLEW -laqsis_core -lv8 -lQtWebKit -lQtScript -lQtOpenGL -lQtGui -lQtCore -lGLU -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
